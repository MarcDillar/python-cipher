...
class CaesarCipherTest(unittest.TestCase):
    ...
    def test_cipher_incorrect_mode(self):
        ...
        with self.assertRaises(ValueError):
            caesar.CaesarCipher().cipher("My message", 2, mode="incorrect cipher type")
    ...
    def test_reversible(self):
        ...
        encrypted_message = caesar.CaesarCipher().encrypt(message, key)
        decrypted_message = caesar.CaesarCipher().decrypt(encrypted_message, key)
